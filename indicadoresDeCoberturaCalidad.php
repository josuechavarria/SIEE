...
<html>
    <head>
        ...
        <meta name="description" content="En este Sitio encontrará Indicadores de Cobertura y Calidad" />
        <link rel="stylesheet" type="text/css" href="css/estiloGeneral.css?v=1" media="screen" />
        <link rel="stylesheet" type="text/css" href="css/estiloPSEC.css?v=1" media="screen" />
        ...
        <script type="text/javascript" src="jqueryLib/jquery-1.8.2.min.js?v=1"></script>
        <script type="text/javascript" src="jQueryUI/jquery-ui-1.8.23.custom/js/jquery-ui-1.8.23.custom.min.js?v=1"></script>
        ...
        <title>Indicadores CC</title>
        <link rel="SHORTCUT ICON" href="favicon_cc.png" />
    </head>
    <body id="cuerpo">
                                    ...
                                    <div id="seccionEncabezadoGeneralSitios">
                                        <div class="seccionPromoSubsitio">
                                            <div class="tituloSitio">
                                                ...
                                                <span class="h1">Indicadores de Cobertura y Calidad&nbsp;&nbsp;</span>
                                                <br/>
                                                <span class="subH1">
                                                    En el Panel de Trabajo encontrar&aacute; los indicadores propuestos para fijar las
                                                    metas y monitorear avances de los indicadores de Cobertura y Calidad, como compromiso
