...
<html>
    <head>
        ...
        <meta name="description" content="En este Sitio encontrará Indicadores de comparación internacional." />
        <link rel="stylesheet" type="text/css" href="css/estiloGeneral.css" />
        <link rel="stylesheet" type="text/css" href="css/estiloECI.css" />
        ...
        <title>Indicadores ECI</title>
        <link rel="SHORTCUT ICON" href="favicon_eci.png"/>
    </head>
    <body id="cuerpo">
            ...
            <div id="contenedorColores" class="contenedorMenusSubsitios">
                <div class="contenedorMenusSubsitiosInterno">
                    ...
                    <div id="navegacionSecuencial" class="navegacionSecunciales">
                        <a href="inicio.php">Inicio - SIEE</a>&nbsp;&raquo;&nbsp;<span>Inicio - ECI</span>
                    </div>
                </div>
                                    ...
                                    <div id="seccionEncabezadoGeneralSitios">
                                        <div class="seccionPromoSubsitio">
                                            <div class="tituloSitio">
                                                ...
                                                <span class="h1">Indicadores Educativos de Comparaci&oacute;n Internacional</span>
                                                <br/>
                                                <span class="subH1">
                                                    Aquí encontrará los indicadores utilizados por la Republica de Honduras en acuerdo
                                                    con la UNESCO, la CECC. Tambien contamos con una seccion de descargas donde podra encontrar
                                                    la misma información en archivos descargables para trabajos externos, <a href="#" class="link">Ir al Centro de Descargas</a>.
                                                </span>
                                            </div>                                            
                                        </div>                                        
                                    </div>
