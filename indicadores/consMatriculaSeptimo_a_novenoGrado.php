...
if (ISSET($_POST['anio']) && ISSET($_POST['departamento']) && ISSET($_POST['municipio']) && ISSET($_POST['centro']) && ISSET($_POST['desagregacion'])) {
    ...
    if (is_numeric($anio) && ctype_digit($anio) && is_numeric($departamento) && ctype_digit($departamento) && is_numeric($municipio) && ctype_digit($municipio) && is_numeric($centro) && ctype_digit($centro) && is_numeric($desagregacion) && ctype_digit($desagregacion)) {
        $indicador = selectIndicadorPorId(13);
        ...
        $septimoGrado_PromedioNacional = $DatosParametrizados_PromedioNacional['septimoGrado']; //cambiar nombre de variable primer grado
        $novenoGrado_PromedioNacional = $DatosParametrizados_PromedioNacional['novenoGrado'];//cambiar nombre de variable sexto grado

        $valorIndicador_PromedioNacional = ($novenoGrado_PromedioNacional / $septimoGrado_PromedioNacional) * 100;


        //calculo del datos para el año 
        $DatosParametrizados_anioBase = $DatosQuery['DatosAnioBase'];
        $septimoGrado_anioBase = $DatosParametrizados_anioBase['septimoGrado'];
        $novenoGrado_anioBase = $DatosParametrizados_anioBase['novenoGrado'];

        $valorIndicador_anioBase = ($novenoGrado_anioBase / $septimoGrado_anioBase) * 100;
        ...
        if ($desagregacion === "0") {
            ...
            $septimoGrado = $DatosParametrizados['septimoGrado'];
            $novenoGrado = $DatosParametrizados['novenoGrado'];

            $valorIndicador = ($novenoGrado / $septimoGrado) * 100;
        } else {
            $DatosParametrizados = $DatosQuery['DatosParametrizados'];
            $septimoGrado_A = $DatosParametrizados['septimoGrado_A'];
            $novenoGrado_A = $DatosParametrizados['novenoGrado_A'];
            $septimoGrado_B = $DatosParametrizados['septimoGrado_B'];
            $novenoGrado_B = $DatosParametrizados['novenoGrado_B'];

            $valorIndicador_A = ($novenoGrado_A / $septimoGrado_A) * 100;
            $valorIndicador_B = ($novenoGrado_B / $septimoGrado_B) * 100;
                            ...
                            if ($desagregacion === "0") {
                                ...
                                <tbody>
                                    <tr >
                                        ...
                                        <td>  
                                             <?php echo number_format($septimoGrado, 0) ?>
                                        </td> 
                                    </tr>
                                    <tr>
                                        <th>
                                        ...
                                        <td>
                                           <?php echo number_format($novenoGrado, 0) ?>
                                        </td> 
                                    </tr> 
                                    <tr>
                                        <th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>  
                                            <?php echo number_format($septimoGrado_A, 0) ?>
                                        </td> 
                                        <td>  
                                            <?php echo number_format($septimoGrado_B, 0) ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>
                                        ...
                                        <td>
                                            <?php echo number_format($novenoGrado_A, 0) ?>
                                        </td>
                                        <td>
                                            <?php echo number_format($novenoGrado_B, 0) ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>
                ...
                $(function () {
                    ...
                    $(document).ready(function() {
                        chart = new Highcharts.Chart({
                            ...
                            xAxis: {
                                categories: ['Matricula 7° Grado', 'Matricula 9° Grado']
                            },
                            yAxis: {
                                min: 0,
                                title: {
                            ...
                            series: [{
                                        ...
                                        data: [<?php echo $septimoGrado ?>,<?php echo $novenoGrado ?>],
                                        type : 'column'
                            ...
                            series: [{
                                        ...
                                        data: [<?php echo $septimoGrado_A ?>,<?php echo $novenoGrado_A ?>]
                                        
                                    },
                                    {
                                        name: 'CMG <?php echo utf8_encode($etiqueta_B) ?>',
                                        data: [<?php echo $septimoGrado_B ?>,<?php echo $novenoGrado_B ?>]
