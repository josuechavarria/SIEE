...
if (ISSET($_POST['anio']) && ISSET($_POST['departamento']) && ISSET($_POST['municipio']) && ISSET($_POST['centro']) && ISSET($_POST['desagregacion'])) {
    ...
    if (is_numeric($anio) && ctype_digit($anio) && is_numeric($departamento) && ctype_digit($departamento) && is_numeric($municipio) && ctype_digit($municipio) && is_numeric($centro) && ctype_digit($centro) && is_numeric($desagregacion) && ctype_digit($desagregacion)) {
        $indicador = selectIndicadorPorId(14);
        ...
        $diezGrado_PromedioNacional = $DatosParametrizados_PromedioNacional['diezGrado']; //cambiar nombre de variable primer grado
        $onceGrado_PromedioNacional = $DatosParametrizados_PromedioNacional['onceGrado'];//cambiar nombre de variable sexto grado

        $valorIndicador_PromedioNacional = ($onceGrado_PromedioNacional / $diezGrado_PromedioNacional) * 100;


        //calculo del datos para el año 
        $DatosParametrizados_anioBase = $DatosQuery['DatosAnioBase'];
        $diezGrado_anioBase = $DatosParametrizados_anioBase['diezGrado'];
        $onceGrado_anioBase = $DatosParametrizados_anioBase['onceGrado'];

        $valorIndicador_anioBase = ($onceGrado_anioBase / $diezGrado_anioBase) * 100;
        ...
        if ($desagregacion === "0") {
            ...
            $diezGrado = $DatosParametrizados['diezGrado'];
            $onceGrado = $DatosParametrizados['onceGrado'];

            $valorIndicador = ($onceGrado / $diezGrado) * 100;
        } else {
            $DatosParametrizados = $DatosQuery['DatosParametrizados'];
            $diezGrado_A = $DatosParametrizados['diezGrado_A'];
            $onceGrado_A = $DatosParametrizados['onceGrado_A'];
            $diezGrado_B = $DatosParametrizados['diezGrado_B'];
            $onceGrado_B = $DatosParametrizados['onceGrado_B'];

            $valorIndicador_A = ($onceGrado_A / $diezGrado_A) * 100;
            $valorIndicador_B = ($onceGrado_B / $diezGrado_B) * 100;
                        ...
                        <table id="<?php echo $indicador['codigo_indicador'] . "-tablaDatosIndicador"; ?>" class="TablaDatosSiee" name="indDataTables" cellspacing="0" cellpadding="0">
                            ...
                            if ($desagregacion === "0") {
                                ...
                                <tbody>
                                    <tr >
                                        <th>
                                            Estudiantes de 10° Grado
                                        </th>
                                        <td>  
                                             <?php echo number_format($diezGrado, 0) ?>
                                        </td> 
                                    </tr>
                                    <tr>
                                        <th>
                                        ...
                                        <td>
                                           <?php echo number_format($onceGrado, 0) ?>
                                        </td> 
                                    </tr> 
                                    <tr>
                                        <th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>  
                                            <?php echo number_format($diezGrado_A, 0) ?>
                                        </td> 
                                        <td>  
                                            <?php echo number_format($diezGrado_B, 0) ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>
                                        ...
                                        <td>
                                            <?php echo number_format($onceGrado_A, 0) ?>
                                        </td>
                                        <td>
                                            <?php echo number_format($onceGrado_B, 0) ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>
                ...
                $(function () {
                    ...
                    $(document).ready(function() {
                        chart = new Highcharts.Chart({
                            ...
                            xAxis: {
                                categories: ['Matricula 10° Grado', 'Matricula 11° Grado']
                            },
                            yAxis: {
                                min: 0,
                                title: {
                            ...
                            series: [{
                                        ...
                                        data: [<?php echo $diezGrado ?>,<?php echo $onceGrado ?>],
                                        type : 'column'
                            ...
                            series: [{
                                        ...
                                        data: [<?php echo $diezGrado_A ?>,<?php echo $onceGrado_A ?>]
                                        
                                    },
                                    {
                                        name: 'CMG <?php echo utf8_encode($etiqueta_B) ?>',
                                        data: [<?php echo $diezGrado_B ?>,<?php echo $onceGrado_B ?>]
