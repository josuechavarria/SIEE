...
if (ISSET($_POST['anio']) && ISSET($_POST['departamento']) && ISSET($_POST['municipio']) && ISSET($_POST['centro']) && ISSET($_POST['desagregacion'])) {
    ...
    if (is_numeric($anio) && ctype_digit($anio) && is_numeric($departamento) && ctype_digit($departamento) && is_numeric($municipio) && ctype_digit($municipio) && is_numeric($centro) && ctype_digit($centro) && is_numeric($desagregacion) && ctype_digit($desagregacion)) {
        $indicador = selectIndicadorPorId(57);
        ...
        $poblacion_PromedioNacional = ($poblacion_PromedioNacional < $matricula_PromedioNacional) ? $matricula_PromedioNacional : $poblacion_PromedioNacional;
        ...
        $poblacion_anioBase = ($poblacion_anioBase < $matricula_anioBase) ? $matricula_anioBase : $poblacion_anioBase;
        ...
        if ($desagregacion === "0") {
           ...
           $poblacion = ($poblacion < $matricula) ? $matricula : $poblacion;
            ...
            $poblacion_A = ($poblacion_A < $matricula_A) ? $matricula_A : $poblacion_A;
            $poblacion_B = ($poblacion_B < $matricula_B) ? $matricula_B : $poblacion_B;
